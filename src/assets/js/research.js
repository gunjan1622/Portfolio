...
const research = [
  {
    ...
    researchYr: 2020,
    citebox: "popup1",
    image: "/src/assets/images/research-page/inteferenceNetwork.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: 2020,
    citebox: "popup2",
    image: "/src/assets/images/research-page/crossLingual.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: 2020,
    citebox: "popup3",
    image: "/src/assets/images/research-page/wordRepresentation.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: 2020,
    citebox: "popup4",
    image: "/src/assets/images/research-page/dialogueState.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: 2020,
    citebox: "popup5",
    image: "/src/assets/images/research-page/semanticSegmentation.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: 2020,
    citebox: "popup6",
    image: "/src/assets/images/research-page/deepNetwork.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: 2020,
    citebox: "popup7",
    image: "/src/assets/images/research-page/imageDecomposition.png",
    citation: {
      vancouver:
  ...
  },
  {
    ...
    researchYr: 2020,
    citebox: "popup8",
    image: "/src/assets/images/research-page/neuralNetworks.jpg",
    citation: {
      vancouver:
